...
if not settings.DEBUG:
    ...
    ALLOWED_HOSTS = ['167.99.80.118', 'telegraph.ng', 'www.telegraph.ng', 'telegraph.com.ng', 'www.telegraph.com.ng', 'telegraph.nakasoft.ng']
    ...
    STATIC_URL = '/static/'
    STATIC_ROOT = '/var/www/static-root/telegraph/'
    STATICFILES_DIRS = (
        os.path.join(BASE_DIR, 'static'),
    )
    MEDIA_URL = '/media/'
    MEDIA_ROOT = '/var/www/media-root/telegraph/'
